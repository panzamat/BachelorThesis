...
def evaluate_global_voxel_rates():
    ...
    for i in folds:
        pred_dir = f"/cfs/earth/scratch/icls/shared/comp-health-lab/data/aneu/nnUNet_Frame/Mattia_BSc_Thesis/multimodal_data/nnUNet_data/nnUNet_results/Dataset064_IA/postprocessed/postprocessed_f{i}"
        gt_dir = f"/cfs/earth/scratch/icls/shared/comp-health-lab/data/aneu/nnUNet_Frame/Mattia_BSc_Thesis/multimodal_data/nnUNet_data/nnUNet_raw/Dataset064_IA/labelsTs"
    ...
    df.to_csv(f"voxelwise_rates_model_level_{dataset}.csv", index=False)
