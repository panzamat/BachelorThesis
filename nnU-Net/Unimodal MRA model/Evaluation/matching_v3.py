""" In this version of matching_aneurysms.py I try to loop over images and connected components, 
without passing by saving intermediate results in csv tables """ 
